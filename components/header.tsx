  ...
  return (
    <header className="container mx-auto mt-10 h-40 px-6 text-center md:h-20">
      ...
      <div className="top-12 right-10 flex items-center justify-center space-x-4 md:absolute md:space-x-10">
        ...
        <button
          id="theme-toggle"
          className="5 rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
        >
          {/* Dark SVG Icon */}
          <svg
